...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        ...
        self.assertEqual(u1.count_following(), 1)
        self.assertEqual(u2.count_followers(), 1)
    ...
    def test_follow_posts(self):
        ...
        f1 = db.session.scalars(u1.get_following_posts()).all()
        f2 = db.session.scalars(u2.get_following_posts()).all()
        f3 = db.session.scalars(u3.get_following_posts()).all()
        f4 = db.session.scalars(u4.get_following_posts()).all()
